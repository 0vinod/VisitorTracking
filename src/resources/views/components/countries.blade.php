...
<div class="container-fluid visitor-dashboard">
    ...
    <div class="row mb-4">
            ...
            <div class="col-md-3 col-6 visitorSetting_total_visitors" style="{{ !$visitorSetting->total_visitors ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_unique_visitors" style="{{ !$visitorSetting->unique_visitors ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_total_visits" style="{{ !$visitorSetting->total_visits ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_top_pages_card" style="{{ !$visitorSetting->top_pages_card ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_bounce_rate" style="{{ !$visitorSetting->bounce_rate ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_online_visitors" style="{{ !$visitorSetting->online_visitors ? "display:none" : ""}}">
            ...
            <div class="col-md-3 col-6 mb-3 visitorSetting_avg_session" style="{{ !$visitorSetting->avg_session ? "display:none" : ""}}">
    ...
    <div class="row">
            ...
            <div class="col-md-12 mb-4 visitorSetting_hit_chart" style="{{ !$visitorSetting->hit_chart ? "display:none" : ""}}">
            ...
            <div class="col-md-12 mb-4 visitorSetting_overview_chart" style="{{ !$visitorSetting->overview_chart ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-12 mb-4 visitorSetting_heatmap" style="{{ !$visitorSetting->heatmap ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-12 mb-4 visitorSetting_top_pages_table" style="{{ !$visitorSetting->top_pages_table ? 'display:none' : ""}}">
                <div class="analytics-box">
                    <h5>Top Pages</h5>
            ...
            <div class="col-md-12 mb-4 visitorSetting_top_visitors" style="{{ !$visitorSetting->top_visitors ? "display:none" : ""}}">
                <div class="analytics-box">
    ...
    <div class="row">
            ...
            <div class="col-md-6 mb-4 visitorSetting_country_chart" style="{{ !$visitorSetting->country_chart ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-6 mb-4 visitorSetting_browser_chart" style="{{ !$visitorSetting->browser_chart ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-6 mb-4 visitorSetting_device_chart" style="{{ !$visitorSetting->device_chart ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-6 mb-4 visitorSetting_os_chart" style="{{ !$visitorSetting->os_chart ? "display:none" : ""}}">
                <div class="analytics-box">
            ...
            <div class="col-md-12 mb-4 visitorSetting_world_map" style="{{ !$visitorSetting->world_map ? "display:none" : ""}}">
                <div class="analytics-box">
